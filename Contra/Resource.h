...
void LoadResource()
{
	...
	aniLib->AddAnimation(PLAYER_LAY_DOWN_RIGHT_ANIMATION, Animation(tex, PLAYER_LAY_DOWN_WIDTH, PLAYER_SPRITE_HEIGHT, 2, 2));
	aniLib->AddAnimation(PLAYER_LAY_DOWN_LEFT_ANIMATION, Animation(tex, PLAYER_LAY_DOWN_WIDTH, PLAYER_SPRITE_HEIGHT, 2, 2,true));
